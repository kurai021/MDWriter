document.getElementById('toLoad').onclick = function(){
  document.getElementById('toLoad-alert').style.display = "block";
}

document.getElementById('close-toLoad').onclick = function(){
  document.getElementById('toLoad-alert').style.display = "none";
}
